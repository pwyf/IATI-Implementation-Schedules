...
publishing_rows = [
    ...
    (),
    (),
    ('split', 'publication-frequency', {'frequency': {'col': 3, 'opts': {0: 'Monthly', 1: 'Quarterly', 2: 'Annually'}}, 'timeliness': {'row': 4, 'col': 2, 'opts': {0: '1 month in arrears', 1: '1 quarter in arrears', 2: '1 year in arrears'}}}), #80
    (),
    ...
    (),
    (),
    ('split', 'license', {'license': {'col': 2, 'opts': {0: 'Public domain', 3: 'Attribution-only'}}}), #150 # row 149 in reality
    (),
    (),
    (),
    (),
