...
publishing_rows = [
    ...
    (),
    (),
    ('split-scope', 'scope', {'current': {'col': 2}, 'future': {'row': 12, 'col': 2}}), #row 35 in reality
    (),
    (),
    (),
    (), #40
    ...
    (),
    (),
    ('split-pub','publication-timetable', 'date-initial'), # row 152 in reality
    (),
    (),
    (),
    (),
